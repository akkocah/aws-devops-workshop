...
- CREATE EC2FULLACCES ROLE from AWS IAM
- ADD THIS ROLE TO CONTROL-NODE EC2
...
ansible all -m ping --key-file "~/mykey.pem" -i inventory_aws_ec2.yml

ansible _Newyork -m ping --key-file "~/virginiaclarus.pem"
```
