...
@app.route("/admin")
def admin():
    return redirect(url_for('error')) # we redirsct to another function
...
#     return f"Hello, {name}"
###############################
# @app.route('/<name>') # This is inline HTML
# def greet(name):
#     greet_format=f"""
# <!DOCTYPE html>
# <html>
...
# Create a function named list10 which creates a list counting from 1 to 10 within `list100.html` 
