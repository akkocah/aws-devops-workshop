...
1. Launch an instance with following configurations.
  ...
  systemctl start nginx --> bu komutlarıda verebiliriz.
  

  c. Key: Name --> Value: SampleInstance  

2. Firt copy the Instance ID and then go to EC2 dashboard and click "Snapshot" section from left-hand menu. i-022a8f1f2c4b89c1e örnek id
...
Instance ID : select the root volume of the SampleInstance örnek baz instancesın volumenü vol-05280f1f5ac28df96
