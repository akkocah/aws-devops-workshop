...
Notification:
  ...
  - Select an SNS topic : 
    - Create new topic
      ...
      - Email endpoints that will receive the notification…: <your email adress>
    - create topic
...
- Go to instance named "Cloudwatch_Log" ---> Actions ---> Instance settings ---> modify-IAM ROLE -Attach/Replace IAM role ----> Attach "CloudWatchLogsFullAccess" role ---> Apply
...
- stop the agent and restart again on terminal
```bash
